...
$factory->define(Lib\Models\Schedule::class,function(Faker $faker){
...
$factory->define(Lib\Models\User::class, function (Faker $faker) {
    static $password;
...
$factory->define(Lib\Models\CarType::class, function(Faker $faker){
  return [
    "name"=>$faker->unique()->name,
...
$factory->define(Lib\Models\Car::class, function (Faker $faker){
    return [
...
$factory->define(Lib\Models\Waypoint::class, function(Faker $faker){
  $geo = str_replace(["\n","\r"],"",trim("{
                    \"address_components\": [
                    {
...
$factory->define(Lib\Models\Run::class, function (Faker $faker){
...
$factory->define(Lib\Models\RunSubscription::class, function(Faker $faker){
  return [
    "status"=>"error"
  ];
});
$factory->define(Lib\Models\Group::class, function (Faker $faker){
    return [
...
$factory->define(Lib\Models\Image::class, function (Faker $faker){
    return [
    ];
});
$factory->state(Lib\Models\Image::class, "license",function (Faker $faker){
  return [
...
$factory->state(Lib\Models\Image::class, "profile",function (Faker $faker){
  return [
